  ...
  async function processItem(item) {
    ...
    try {
      ...
      const data = await api('/api/chat', {
        method: 'POST',
        body: JSON.stringify({ session_id: requestSid, message: item.text }),
      });
        ...
        <div className="composer-zone">
          ...
          <div className="composer">
            <textarea
              ...
              placeholder={
                loading ? 'Agent 正在回答，可继续输入，发送后自动排队…' : '输入 AWS 相关问题...'
              }
            />
            <button
              type="button"
